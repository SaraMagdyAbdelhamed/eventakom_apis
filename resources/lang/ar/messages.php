...
return [
	...
	'wrong_membership_code'=> 'رقم العضوية غير مسجل',
	'wrong_writable_code' => 'المطلوب ادخال ارقام فقط ',
	...
	'logged'=>'هذا المستخدم غير مصرح له ادخل الى التطبيق ثم حاول ثانيا',
	'sms'=>'تم ارسال الكود بنجاح',
	'notlawyer'=>'هذا المستخدم ليس محامى ',
	'task_not_found'=>'غير مسجله',
	'notclient'=>'هذا المستخدم ليس عميل ',
	'notclientorlawyer'=>'هذا المستخدم ليس عميل ولا محامى ',
	'lawyer_not_assigned'=>'هذا المحامى ليس له الحق للرد على هذه الاستشاره ',
    ...
    'edit_event'=>'ليس لديك الصلاحية للتعديل في هذا الإيفنت'
