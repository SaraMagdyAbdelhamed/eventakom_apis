...
class EventsController extends Controller
{
    ...
    public function add_event(Request $request){
        ...
        dd( $twilio->send($event->tele_code.$event->mobile, 'Event '.$event->name.' subscribers link '.$subscribers_link));
         }
        
        if($user->tel_code != null  && $user->mobile != null ){            
         $twilio->send($user->tele_code.$user->mobile,'Event '.$event->name.' subscribers link '.$subscribers_link);
        }
