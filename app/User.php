...
class User extends Model implements AuthenticatableContract, AuthorizableContract
{
    ...
    protected $fillable = [
        ...
        'social_token','lang_id','is_verification_code_expired','last_login','longtuide','latitude','password','verification_code','access_token','api_token','verification_date','birthdate','gender_id'
    ];
